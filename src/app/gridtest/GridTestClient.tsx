...
function VideoGridCard({ video, onClick, loadIndex = 0, className = "" }: VideoGridCardProps) {
  ...
  return (
    <div
      className={`relative ${className} bg-black overflow-hidden cursor-pointer group aspect-video`}
      onClick={onClick}
